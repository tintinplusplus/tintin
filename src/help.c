...
struct help_type help_table[] =
{
	...
	},
	{
		...
		"\n"
		"         dark azure, dark ebony, dark jade, dark lime, dark orange, dark silver,\n"
		"         dark tan, dark violet, light azure, light ebony, light jade, light lime,\n"
		"         light orange, light silver, light tan, light violet.\n"
		"\n"
