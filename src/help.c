...
{
	{
		...
		"         string is found it will execute the commands.  Variables %0 to %99\n"
		"         are substituted from the input string, and can be used in the command.\n"
		"         Brackets and pipes can be used for selective keywords. %{variable} can\n"
		"         be used to store a variable directly into a tintin variable.\n"
		...
		"\n"
		"<178>Example<078>: #act {%{reply} tells you '%{lasttell}'} {say $reply said $lasttell}\n"
		"\n"
