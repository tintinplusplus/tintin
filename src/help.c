...
//		"<068>      #<078>                             1992, 2010                            <068>#\n"
	...
	},
	{
		...
		"                                                escapes, in the given argument,\n"
		"                                                next executes it as a command.\n"
		"\n"
	...
	},
	{
		...
		"\n"
		"         #map dig <direction> [new]: Creates an exit in the given direction. If\n"
		"                  no valid direction is given or no existing room is found a new\n"
		"                  room is created. Useful for portal links and other alternative\n"
		"                  forms of transportation. If the 'new' argument is provided all\n"
		"                  existing rooms are ignored.\n"
		"\n"
		...
		"\n"
		"         #map exitdir <exit name> <exit direction>: Set the exit direction. This\n"
		"                  is useful if you have an unusual type of exit with a known\n"
		"                  direction, like for example a tree that can be climbed.\n"
		"\n"
		...
		"                  is the filename argument to log the map output to file.\n"
		"\n"
		...
		"\n"
		"         #map set <option> <value> [vnum]: Set a map value for your current room,\n"
		"                  or given room if a room vnum is provided.\n"
		"\n"
